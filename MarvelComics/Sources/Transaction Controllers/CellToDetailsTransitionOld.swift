...
class CellToDetailsTransitionOld: NSObject {
...
extension CellToDetailsTransitionOld {
    enum CircularTransitionMode: Int {
        case present, dismiss, pop
    }
}

extension CellToDetailsTransitionOld: UIViewControllerAnimatedTransitioning {
